...
<fieldset>
NO DIAGNOSA : <big><b><?php echo "$no_konsul"; ?></b></big>
</fieldset>
<fieldset>
<h3>DATA PASIEN</h3>
<p>Nama Lengkap<br>
...
<?php
  $no=1;
  $strsqlku= mysql_query("select * from diagnosa where id_member=$rm[id_member] and no_konsul='$_GET[no_konsul]'");
...
$sqlh = mysql_query("select * from hasil_diagnosa where id_member='$rm[id_member]' and no_konsul='$_GET[no_konsul]'");
...
<fieldset>
&copy; SISTEM PAKAR DIAGNOSA PENYAKIT IBU HAMIL
</fieldset>
</body>
</fieldset>
