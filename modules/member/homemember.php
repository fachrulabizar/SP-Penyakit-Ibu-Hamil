...
$nama=$rm['nama'];
echo "<center style='font-family:GreyscaleBasic;font-weight:bold;'><h2><span style='font-size:23px'><u> Selamat Datang $nama</u></span></br></br>SISTEM PAKAR DIAGNOSA PENYAKIT IBU HAMIL  </h2></center>";
?>
