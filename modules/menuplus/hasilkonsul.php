...
$sqlh = mysql_query("select * from hasil_diagnosa where id_member='$rm[id_member]' order by no_konsul desc");

?>

<div >
<a href='?r=hasildiagnosa'class='btn btn-success' > <span class='glyphicon glyphicon-edit'></span> Back</a>
</div>
...
<tr id='thpo'>
  ...
  <th class="text-center">HASIL DIAGNOSA PENYAKIT</th>
  <th class="text-center">GEJALA</th>
  <th class="text-center">CF</th>
  <th width='20%' class="text-center">WAKTU DIAGNOSA</th>
