...
<center style="font-family:GreyscaleBasic;font-weight:bold;">
    <font size="6" color="black">Hasil Diagnosa</font>
...
//untuk mengambil nama dari gejala dari tabel diagnosa
$strsqlku="select * from diagnosa where id_member=$rm[id_member] and no_konsul=$no_konsul";
...
echo"</tr>";
$g01=mysql_num_rows(mysql_query("SELECT * FROM diagnosa where  kd_gejala='G01' and no_konsul='$_GET[no_konsul]'"));
$g02=mysql_num_rows(mysql_query("SELECT * FROM diagnosa where  kd_gejala='G02' and no_konsul='$_GET[no_konsul]'"));
$g03=mysql_num_rows(mysql_query("SELECT * FROM diagnosa where  kd_gejala='G03' and no_konsul='$_GET[no_konsul]'"));
$g04=mysql_num_rows(mysql_query("SELECT * FROM diagnosa where  kd_gejala='G04' and no_konsul='$_GET[no_konsul]'"));
$g06=mysql_num_rows(mysql_query("SELECT * FROM diagnosa where  kd_gejala='G06' and no_konsul='$_GET[no_konsul]'"));
$g07=mysql_num_rows(mysql_query("SELECT * FROM diagnosa where  kd_gejala='G07' and no_konsul='$_GET[no_konsul]'"));
$g08=mysql_num_rows(mysql_query("SELECT * FROM diagnosa where  kd_gejala='G08' and no_konsul='$_GET[no_konsul]'"));
$g05=mysql_num_rows(mysql_query("SELECT * FROM diagnosa where  kd_gejala='G05' and no_konsul='$_GET[no_konsul]'"));
$g09=mysql_num_rows(mysql_query("SELECT * FROM diagnosa where  kd_gejala='G09' and no_konsul='$_GET[no_konsul]'"));
$g10=mysql_num_rows(mysql_query("SELECT * FROM diagnosa where  kd_gejala='G10' and no_konsul='$_GET[no_konsul]'"));
$g11=mysql_num_rows(mysql_query("SELECT * FROM diagnosa where  kd_gejala='G11' and no_konsul='$_GET[no_konsul]'"));
$g12=mysql_num_rows(mysql_query("SELECT * FROM diagnosa where  kd_gejala='G12' and no_konsul='$_GET[no_konsul]'"));
$g13=mysql_num_rows(mysql_query("SELECT * FROM diagnosa where  kd_gejala='G13' and no_konsul='$_GET[no_konsul]'"));
$g14=mysql_num_rows(mysql_query("SELECT * FROM diagnosa where  kd_gejala='G14' and no_konsul='$_GET[no_konsul]'"));
$g15=mysql_num_rows(mysql_query("SELECT * FROM diagnosa where  kd_gejala='G15' and no_konsul='$_GET[no_konsul]'"));
...
if(($g01 > 0)&& ($g02 > 0) && ($g03 > 0) ){
  ...
  $cfp11 = mysql_fetch_array(mysql_query("SELECT * FROM diagnosa where kd_gejala='G01'and no_konsul='$_GET[no_konsul]'"));
  $cfp12 = mysql_fetch_array(mysql_query("SELECT * FROM diagnosa where kd_gejala='G02'and no_konsul='$_GET[no_konsul]'"));
  $cfp14 = mysql_fetch_array(mysql_query("SELECT * FROM diagnosa where kd_gejala='G03'and no_konsul='$_GET[no_konsul]'"));
...
if(($g01 > 0)&&($g02 > 0) && ($g05 > 0) ){
  ...
  $cfp21 = mysql_fetch_array(mysql_query("SELECT * FROM diagnosa where kd_gejala='G01'and no_konsul='$_GET[no_konsul]'"));
  $cfp22 = mysql_fetch_array(mysql_query("SELECT * FROM diagnosa where kd_gejala='G02'and no_konsul='$_GET[no_konsul]'"));
  $cfp25 = mysql_fetch_array(mysql_query("SELECT * FROM diagnosa where kd_gejala='G05'and no_konsul='$_GET[no_konsul]'"));
...
$cfp31 = mysql_fetch_array(mysql_query("SELECT * FROM diagnosa where kd_gejala='G01'and no_konsul='$_GET[no_konsul]'"));
$cfp33 = mysql_fetch_array(mysql_query("SELECT * FROM diagnosa where kd_gejala='G03'and no_konsul='$_GET[no_konsul]'"));
$cfp35 = mysql_fetch_array(mysql_query("SELECT * FROM diagnosa where kd_gejala='G05'and no_konsul='$_GET[no_konsul]'"));
...
//RULE 4	IF G3 AND G4 AND G5 THEN P1 (0,55)
		if(($g02 > 0) && ($g03 > 0) && ($g04 > 0)){
			$cfp43 = mysql_fetch_array(mysql_query("SELECT * FROM diagnosa where kd_gejala='G02'and no_konsul='$_GET[no_konsul]'"));
			$cfp44 = mysql_fetch_array(mysql_query("SELECT * FROM diagnosa where kd_gejala='G03'and no_konsul='$_GET[no_konsul]'"));
			$cfp45 = mysql_fetch_array(mysql_query("SELECT * FROM diagnosa where kd_gejala='G04'and no_konsul='$_GET[no_konsul]'"));
...
//RULE 5 	IF G6 AND G7 AND G8 THEN P2 (0,8)
		if(($g06 > 0) && ($g07 > 0) && ($g08 > 0)){
			$cfp56 = mysql_fetch_array(mysql_query("SELECT * FROM diagnosa where kd_gejala='G06'and no_konsul='$_GET[no_konsul]'"));
			$cfp57 = mysql_fetch_array(mysql_query("SELECT * FROM diagnosa where kd_gejala='G07'and no_konsul='$_GET[no_konsul]'"));
			$cfp58 = mysql_fetch_array(mysql_query("SELECT * FROM diagnosa where kd_gejala='G08'and no_konsul='$_GET[no_konsul]'"));
...
//RULE 6	IF G6 AND G7 THEN P2(0,7)
		if(($g06 > 0)  && ($g07 > 0)){
			$cfp66 = mysql_fetch_array(mysql_query("SELECT * FROM diagnosa where kd_gejala='G06'and no_konsul='$_GET[no_konsul]'"));
			$cfp67 = mysql_fetch_array(mysql_query("SELECT * FROM diagnosa where kd_gejala='G07'and no_konsul='$_GET[no_konsul]'"));
...
//RULE 7	IF G6 AND G8 AND G9 THEN P2 (0,7)
		if(($g06 > 0) && ($g08 > 0)&& ($g09 > 0)){
			...
			$cfp76 = mysql_fetch_array(mysql_query("SELECT * FROM diagnosa where kd_gejala='G06'and no_konsul='$_GET[no_konsul]'"));
			$cfp78 = mysql_fetch_array(mysql_query("SELECT * FROM diagnosa where kd_gejala='G08'and no_konsul='$_GET[no_konsul]'"));
			$cfp79 = mysql_fetch_array(mysql_query("SELECT * FROM diagnosa where kd_gejala='G09'and no_konsul='$_GET[no_konsul]'"));
...
//RULE 8 IF G10 AND G11 AND G12 THEN P03(0.8)
    if(($g10 > 0) && ($g11 > 0)&& ($g12 > 0)){

      $cfp810 = mysql_fetch_array(mysql_query("SELECT * FROM diagnosa where kd_gejala='G10'and no_konsul='$_GET[no_konsul]'"));
      $cfp811 = mysql_fetch_array(mysql_query("SELECT * FROM diagnosa where kd_gejala='G11'and no_konsul='$_GET[no_konsul]'"));
      $cfp812 = mysql_fetch_array(mysql_query("SELECT * FROM diagnosa where kd_gejala='G12'and no_konsul='$_GET[no_konsul]'"));
...
//RULE 9	IF G10 AND G11 THEN P03 (0,5)
		if(($g10 > 0)&& ($g11 > 0)){
			$cfp910 = mysql_fetch_array(mysql_query("SELECT * FROM diagnosa where kd_gejala='G10'and no_konsul='$_GET[no_konsul]'"));
			$cfp911 = mysql_fetch_array(mysql_query("SELECT * FROM diagnosa where kd_gejala='G11'and no_konsul='$_GET[no_konsul]'"));
...
//RULE 10	IF G10 AND G12 THEN P3 (0,75)
			...
			$cfp1010 = mysql_fetch_array(mysql_query("SELECT * FROM diagnosa where kd_gejala='G09'and no_konsul='$_GET[no_konsul]'"));
			$cfp1012 = mysql_fetch_array(mysql_query("SELECT * FROM diagnosa where kd_gejala='G10'and no_konsul='$_GET[no_konsul]'"));
...
//RULE 11	IF G13 AND G14 AND G15 THEN P4 (0,8)
    		if(($g13 > 0) && ($g14 > 0)&& ($g15 > 0)){
    			...
    			$cfp1113 = mysql_fetch_array(mysql_query("SELECT * FROM diagnosa where kd_gejala='G13'and no_konsul='$_GET[no_konsul]'"));
          $cfp1114 = mysql_fetch_array(mysql_query("SELECT * FROM diagnosa where kd_gejala='G14'and no_konsul='$_GET[no_konsul]'"));
          $cfp1115 = mysql_fetch_array(mysql_query("SELECT * FROM diagnosa where kd_gejala='G15'and no_konsul='$_GET[no_konsul]'"));
...
//RULE 12	IF G13 AND G15 THEN P4 (0,7)
		if(($g13 > 0) && ($g15 > 0)){
			...
			$cfp1213 = mysql_fetch_array(mysql_query("SELECT * FROM diagnosa where kd_gejala='G13'and no_konsul='$_GET[no_konsul]'"));
			$cfp1215 = mysql_fetch_array(mysql_query("SELECT * FROM diagnosa where kd_gejala='G15'and no_konsul='$_GET[no_konsul]'"));
...
//RULE 13	IF G13 AND G14 THEN P4 (0,6)
		if(($g13 > 0) && ($g14 > 0)){
			...
			$cfp1313 = mysql_fetch_array(mysql_query("SELECT * FROM diagnosa where kd_gejala='G13'and no_konsul='$_GET[no_konsul]'"));
			$cfp1314 = mysql_fetch_array(mysql_query("SELECT * FROM diagnosa where kd_gejala='G14'and no_konsul='$_GET[no_konsul]'"));
...
//P04 --> h11
    ...
    $sqlpen = mysql_query("select * from penyakit order by id_penyakit asc");
    $rpen = mysql_fetch_array($sqlpen);
    $penanggulangan=$rpen['penanggulangan'];

  //  mysql_query("insert into hasil_diagnosa (no_konsul,id_member,kd_penyakit,cf,waktu)values('$no_konsul','$idmember','P01','$h1akhirf',NOW())");
  //  mysql_query("insert into hasil_diagnosa (no_konsul,id_member,kd_penyakit,cf,waktu)values('$no_konsul','$idmember','P02','$h2akhirf',NOW())");
  //  mysql_query("insert into hasil_diagnosa (no_konsul,id_member,kd_penyakit,cf,waktu)values('$no_konsul','$idmember','P03','$h3akhirf',NOW())");
  //  mysql_query("insert into hasil_diagnosa (no_konsul,id_member,kd_penyakit,cf,waktu)values('$no_konsul','$idmember','P04','$h4akhirf',NOW())");

   if($htotal==0){  echo "Anda Tidak Terindikasi Penyakit Yang Serius ";
                    mysql_query("insert into hasil_diagnosa (no_konsul,id_member,kd_penyakit,cf1,cf2,cf3,cf4,max,waktu)values('$no_konsul','$idmember','', '', '', '', '', '',NOW())");


   }else{
     if($htotal==$h1hasilakhir){
       echo" Kemungkinan Anda Terindikasi Penyakit TORCH : $hakhir %";
       mysql_query("insert into hasil_diagnosa (no_konsul,id_member,kd_penyakit,cf1,cf2,cf3,cf4,max,waktu)values('$no_konsul','$idmember','P01', '$h1akhirf', '$h2akhirf', '$h3akhirf', '$h4akhirf', '$hakhir',NOW())");
       echo"<br>";
       echo"<br>";
       $sqlpen = mysql_query("select * from penyakit where kd_penyakit='P01'");
       $rpen = mysql_fetch_array($sqlpen);
       $ket = $rpen['keterangan'];
       $penanggulangan=$rpen['penanggulangan'];
       echo"<br>";
       ...
       echo" Kemungkinan Anda Terindikasi Penyakit HEPATITIS B : $hakhir %";
       mysql_query("insert into hasil_diagnosa (no_konsul,id_member,kd_penyakit,cf1,cf2,cf3,cf4,max,waktu)values('$no_konsul','$idmember','P02','$h1akhirf','$h2akhirf','$h3akhirf','$h4akhirf','$hakhir',NOW())");
       $sqlpen = mysql_query("select * from penyakit where kd_penyakit='P02'");
       $rpen = mysql_fetch_array($sqlpen);
       $ket = $rpen['keterangan'];
       $penanggulangan=$rpen['penanggulangan'];
       echo"<br>";
      ...
      echo"<a href='cetak.php?&no_konsul=$no_konsul' target='_blank'><button type='button' id='btn-cetak' class='btn'> CETAK</button></a>";
       ...
       echo" Kemungkinan Anda Terindikasi Penyakit ANEMIA : $hakhir %";
       mysql_query("insert into hasil_diagnosa (no_konsul,id_member,kd_penyakit,cf1,cf2,cf3,cf4,max,waktu)values('$no_konsul','$idmember','P03','$h1akhirf','$h2akhirf','$h3akhirf','$h4akhirf','$hakhir',NOW())");
       $sqlpen = mysql_query("select * from penyakit where kd_penyakit='P03'");
       $rpen = mysql_fetch_array($sqlpen);
       $ket = $rpen['keterangan'];
       $penanggulangan=$rpen['penanggulangan'];
       echo"<br>";
      ...
      echo"<a href='cetak.php?&no_konsul=$no_konsul' target='_blank'><button type='button' id='btn-cetak' class='btn'> CETAK</button></a>";
       ...
       echo" Kemungkinan Anda Terindikasi Penyakit KEPUTIHAN : $hakhir %";
       echo"<br>";
       mysql_query("insert into hasil_diagnosa (no_konsul,id_member,kd_penyakit,cf1,cf2,cf3,cf4,max,waktu)values('$no_konsul','$idmember','P04','$h1akhirf','$h2akhirf','$h3akhirf','$h4akhirf','$hakhir',NOW())");
        $sqlpen = mysql_query("select * from penyakit where kd_penyakit='P04'");
        $rpen = mysql_fetch_array($sqlpen);
        $ket = $rpen['keterangan'];
        $penanggulangan=$rpen['penanggulangan'];
        echo"<br>";
...
//tampilan rule 1
   ...
   if(($g01>0)&&($g02>0)&&($g03>0)){  
      ...
      echo"Rule 1 : G01($nilai11) AND G02($nilai12) AND G03($nilai13) THEN TORCH (0,85) ";
      echo"<br>";
 ...
 //rule 2
   if(($g01>0)&&($g02>0)&&($g05>0)){
      echo"Rule 2 : G01($nilai21) AND G02($nilai22) AND G05($nilai25) THEN TORCH (0,7) ";
      echo"<br>";
...
//rule 3
   if(($g01>0)&&($g03>0)&&($g05>0)){
      echo"Rule 3 : G02($nilai31) AND G03($nilai33) AND G05($nilai35) THEN TORCH (0,6) ";
      echo"<br>";
 ...
 //rule 4
    if(($g02>0)&&($g03>0)&&($g04>0)){
      echo"Rule 4 : G02($nilai43) AND G03($nilai44) AND G04($nilai45) THEN TORCH (0,55) ";
      echo"<br>";
...
//rule 5
    if(($g06>0)&&($g07>0)&&($g08>0)){
      echo"Rule 5 : G06($nilai56) AND G07($nilai57) AND G08($nilai58) THEN  HEPATITIS B (0,8) ";
      echo"<br>";
...
//rule 6
    if(($g06>0)&&($g07>0)){
      echo"Rule 6 : G06($nilai66) AND G07($nilai67) THEN  HEPATITIS B (0,7) ";
      echo"<br>";
...
//rule 7
    if(($g06>0)&&($g08>0)&&($g09>0)){
      echo"Rule 7 : G06($nilai76) AND G08($nilai78) AND G09($nilai79) THEN  HEPATITIS B (0,7) ";
      echo"<br>";
...
//rule 8
    if(($g10>0)&&($g11>0)&&($g12>0)){
      echo"Rule 8 : G10($nilai810) AND G11($nilai811) AND G12($nilai812) THEN  ANEMIA(0,8) ";
      echo"<br>";
...
//rule 9
    if(($g10>0)&&($g11>0)){
      echo"Rule 9 : G10($nilai910) AND G11($nilai911) THEN  ANEMIA(0,6) ";
      echo"<br>";
...
//rule 10
    if(($g09>0)&&($g10>0)){
      echo"Rule 10 : G09($nilai1010) AND G10($nilai1012) THEN  ANEMIA(0,75) ";
      echo"<br>";
...
//rule 11
    if(($g13>0)&&($g14>0)&&($g15>0)){
      echo"Rule 11 : G13($nilai1113) AND G14($nilai1114) AND G15($nilai1115) THEN  KEPUTIHAN (0,8) ";
      echo"<br>";
...
//rule 12
    if(($g13>0)&&($g15>0)){
      echo"Rule 12 : G13($nilai1213) AND G15($nilai1215) THEN  KEPUTIHAN (0,7) ";
      echo"<br>";
...
//rule 13
    if(($g13>0)&&($g14>0)){
      echo"Rule 13 : G13($nilai1313) AND G14($nilai1314) THEN  KEPUTIHAN (0,5) ";
      echo"<br>";
...
echo"<p align='left'>";
echo"1. TORCH  = $h1akhirf <br>";
echo"2. HEPATITIS B = $h2akhirf<br>";
echo"3. ANEMIA= $h3akhirf<br>";
echo"4. KEPUTIHAN = $h4akhirf<br>";
echo"</p>";
}
  ...
  echo"1. TORCH = $h1akhirf<br>";
  echo"2. HEPATITIS B = $h2akhirf<br>";
  echo"3. KEPUTIHAN = $h4akhirf<br>";
  echo"</p>";
}
else if(($h1akhir>0)&&($h3akhir>0)&&($h4akhir>0)){
  echo"<p align='left'>";
  echo"1. TORCH =TORCH = $h1akhirf<br>";
  echo"2. ANEMIA= $h3akhirf<br>";
  echo"3. KEPUTIHAN = $h4akhirf<br>";
  echo"</p>";
}
else if(($h2akhir>0)&&($h3akhir>0)&&($h4akhir>0)){
  echo"<p align='left'>";
  echo"1. HEPATITIS B = $h2akhirf<br>";
  echo"2. ANEMIA= $h3akhirf<br>";
  echo"3. KEPUTIHAN = $h4akhirf<br>";
  echo"</p>";
}
...
if(($htotal == $h1hasilakhir)&&($htotal>0)){
  echo"Dari Hasil Di atas Maka disimpulkan bahwa kemungkinan Anda Terindikasi penyakit TORCH dengan tingkat kepastian $hakhir %";
}
else if(($htotal == $h2hasilakhir)&&($htotal>0)){
  echo"Dari Hasil Di atas Maka disimpulkan bahwa kemungkinan Anda Terindikasi penyakit HEPATITIS B dengan tingkat kepastian $hakhir %";
}
else if(($htotal == $h3hasilakhir)&&($htotal>0)){
  echo"Dari Hasil Di atas Maka disimpulkan bahwa kemungkinan Anda Terindikasi penyakit ANEMIA dengan tingkat kepastian $hakhir %";
}
else if(($htotal == $h4hasilakhir)&&($htotal>0)){
  echo"Dari Hasil Di atas Maka disimpulkan bahwa kkemungkinan Anda Terindikasi penyakit KEPUTIHAN dengan tingkat kepastian $hakhir %";
}else{
  echo"";
}
echo"</p>";
...
<p style="color:red">Note : Untuk lebih lanjut tentang Penyakit pada diri anda, silahkan hubungi dokter terkait guna penanganan lebih lanjut.</p>
