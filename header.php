...
<nav class="navbar navbar-light" style="background-color:#2A2B2F;">
 <div class="collapse navbar-collapse">
  <ul class="nav navbar-nav navbar-left" id="textheader">
    <font  face="Berlin Sans FB" size="6"  color="white"><i class=""></i> CERTAINTY FACTOR DIAGNOSA PENYAKIT IBU HAMIL </font>
  </ul>
            ...
            <li class='dropdown' >
              <a id='a-memberkananatas' href='#'  class='dropdown-toggle' data-toggle='dropdown'><i class='glyphicon glyphicon-user' ></i>  $rm[nama] <strong class='caret'></strong></a>
                <ul id='ul-memberkananatas' class='dropdown-menu' >
                  ...
                  <li><a id='akananatas' href='?r=hasilkonsul'><i class='glyphicon glyphicon-saved'></i> Hasil Diagnosa</a></li>
